...
<!--Header-->
   ...
   ?>
    ...
    <form action="manage_website2.php" method="post" >
    Expected Sales:<input type="number" name="expectedsales"> 
	Expected New Customer:<input type="number" name="expectedcustomer"> 
	Expected Visitor:<input type="number" name="expectedvisitor"> 
	Expected Total Orders:<input type="number" name="expectedorders"> 
	...
	<div class="details" >         <!--CSS styling for the division -->
     ...
     RM<?php echo $row3["totalsales"];?><br>
	  	 <!--Bootstrap class for image automatically adjust to size of screen -->
